...
<sub>Problem</sub> | <sub>Difficulty</sub> | <sub>C</sub> | <sub>C++</sub> | <sub>Java</sub> | <sub>JS</sub> | <sub>Python</sub> | <sub>Rust</sub> | <sub>TS</sub>
---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ----
<sub>[2076 - Process Restricted Friend Requests](https://leetcode.com/problems/process-restricted-friend-requests)</sub> | <sub>🔴 Hard</sub> | <sub><div align='center'>❌</div></sub> | <sub><div align='center'>[✔️](cpp%2F2076-process-restricted-friend-requests%2FREADME.md)</div></sub> | <sub><div align='center'>❌</div></sub> | <sub><div align='center'>❌</div></sub> | <sub><div align='center'>❌</div></sub> | <sub><div align='center'>❌</div></sub> | <sub><div align='center'>❌</div></sub>
